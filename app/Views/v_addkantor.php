	...
	<div class="panel panel-default">
		...
		<div class="panel-body">
			...
			<div class="form-group">
				...
				<input class="form-control" type="text" name="nama_kantor" placeholder="Nama Kantor">
			</div>
			<div class="form-group">
				<label>No Telpon</label>
				<input class="form-control" name="no_telp" placeholder="No. Telpon">
			</div>
			<div class="form-group">
				<label>Alamat</label>
			...
			<div class="form-group">
				...
				<input class="form-control" name="lat" id="lat" placeholder="Latitude">
			</div>
			<div class="form-group">
				<label>Longitude</label>
				<input class="form-control" name="long" id="long" placeholder="Longitude">
			</div>
			<div class="form-group">
